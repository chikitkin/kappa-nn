...
int main(int argc, char** argv) {
    ...
    outf.open("c:/Users/st024385/Documents/Code/kappa-tests/bulk_viscosity/bulk_" + mol.name + "_" + at.name + "_xat" + std::to_string(x_atom_perc) + ".txt");
    outf_pure.open("c:/Users/st024385/Documents/Code/kappa-tests/bulk_viscosity/bulk_" + mol.name + "_pure.txt");
    outf_xat99.open("c:/Users/st024385/Documents/Code/kappa-tests/bulk_viscosity/bulk_" + mol.name + "_" + at.name + "_xat99.txt");
    outf_xat01.open("c:/Users/st024385/Documents/Code/kappa-tests/bulk_viscosity/bulk_" + mol.name + "_" + at.name + "_xat01.txt");
